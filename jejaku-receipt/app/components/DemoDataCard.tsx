  ...
  return (
    <div className="rounded-lg border border-hairline bg-canvas p-[24px]">
      ...
      <p className="mt-[8px] max-w-md text-[12px] leading-relaxed text-ink-mute">
        {hasDemo
          ? `You currently have ${demoCount} real scanned sample receipts (photos included) mixed in — remove just those, and anything you've entered yourself stays untouched.`
          : `Load ${DEMO_EXPENSES.length} real scanned sample receipts (photos included) so the dashboard charts have something to show. Safe to add even if you already have real expenses.`}
      </p>
