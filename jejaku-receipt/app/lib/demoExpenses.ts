...
export const DEMO_EXPENSES: DemoExpense[] = [
  ...
  { merchant: "GSC Cinemas", amount: 32, currency: "MYR", date: "2026-08-18", category: "Entertainment", city: "Petaling Jaya", state: "Selangor", country: "Malaysia", note: "Movie night", items: [{ name: "Movie ticket x2", price: 26 }, { name: "Popcorn combo", price: 6 }] },
  { merchant: "Din Tai Fung", amount: 96.5, currency: "SGD", date: "2026-08-20", category: "Food & Drink", tax: 6.75, city: "Singapore", country: "Singapore", note: "Business trip dinner", items: [{ name: "Xiao long bao", price: 18.9 }, { name: "Fried rice", price: 16.5 }, { name: "Iced tea x2", price: 9 }, { name: "Pork dumplings", price: 22.68 }, { name: "Wontons in chili oil", price: 22.67 }] },
  ...
  { merchant: "GSC Cinemas", amount: 29, currency: "MYR", date: "2026-08-24", category: "Entertainment", city: "Petaling Jaya", state: "Selangor", country: "Malaysia", items: [{ name: "Movie ticket x2", price: 26 }, { name: "Soda", price: 3 }] },
  ...
  { merchant: "H&M", amount: 98, currency: "MYR", date: "2026-07-27", category: "Shopping", tax: 5.6, city: "Kuala Lumpur", country: "Malaysia", items: [{ name: "T-shirt x2", price: 55.63 }, { name: "Cap", price: 36.77 }] },
  ...
  { merchant: "GSC Cinemas", amount: 30, currency: "MYR", date: "2026-07-23", category: "Entertainment", city: "Petaling Jaya", state: "Selangor", country: "Malaysia", items: [{ name: "Movie ticket x2", price: 26 }, { name: "Soda", price: 4 }] },
  { merchant: "H&M", amount: 87, currency: "MYR", date: "2026-07-30", category: "Shopping", tax: 4.9, city: "Kuala Lumpur", country: "Malaysia", items: [{ name: "Jeans", price: 65.11 }, { name: "Socks x3", price: 16.99 }] },
  ...
  { merchant: "GSC Cinemas", amount: 36, currency: "MYR", date: "2026-06-20", category: "Entertainment", city: "Petaling Jaya", state: "Selangor", country: "Malaysia", note: "Movie night", items: [{ name: "Movie ticket x2", price: 26 }, { name: "Popcorn combo", price: 10 }] },
  { merchant: "Uniqlo", amount: 112, currency: "MYR", date: "2026-06-26", category: "Shopping", tax: 6.3, city: "Kuala Lumpur", country: "Malaysia", items: [{ name: "Hoodie", price: 85.8 }, { name: "Socks x3", price: 19.9 }] },
  ...
  { merchant: "GSC Cinemas", amount: 34, currency: "MYR", date: "2026-06-24", category: "Entertainment", city: "Petaling Jaya", state: "Selangor", country: "Malaysia", items: [{ name: "Movie ticket x2", price: 26 }, { name: "Soda", price: 8 }] },
  ...
  { merchant: "Din Tai Fung", amount: 78.2, currency: "SGD", date: "2026-05-14", category: "Food & Drink", tax: 5.5, city: "Singapore", country: "Singapore", note: "Weekend trip", items: [{ name: "Xiao long bao", price: 16.9 }, { name: "Fried rice", price: 14.5 }, { name: "Iced tea x2", price: 8 }, { name: "Green beans", price: 16.65 }, { name: "Jasmine rice", price: 16.65 }] },
  ...
  { merchant: "Nando's", amount: 45.6, currency: "MYR", date: "2026-04-10", category: "Food & Drink", tax: 2.6, city: "Kuala Lumpur", country: "Malaysia", note: "Dinner with friends", items: [{ name: "Quarter chicken x2", price: 31.02 }, { name: "Coleslaw", price: 11.98 }] },
  ...
  { merchant: "GSC Cinemas", amount: 30, currency: "MYR", date: "2026-04-20", category: "Entertainment", city: "Petaling Jaya", state: "Selangor", country: "Malaysia", items: [{ name: "Movie ticket x2", price: 26 }, { name: "Soda", price: 4 }] },
  ...
  { merchant: "GSC Cinemas", amount: 28, currency: "MYR", date: "2026-03-22", category: "Entertainment", city: "Petaling Jaya", state: "Selangor", country: "Malaysia", items: [{ name: "Movie ticket x2", price: 26 }, { name: "Soda", price: 2 }] },
  ...
  { merchant: "GNC", amount: 88, currency: "MYR", date: "2026-03-25", category: "Health", tax: 5, city: "Kuala Lumpur", country: "Malaysia", note: "Vitamins", items: [{ name: "Multivitamin bottle", price: 54.7 }, { name: "Protein bar x3", price: 28.3 }] },
];
