...
// (e.g. "2026-09-04" -> "Fri, 2026-09-04") — for cases where a raw ISO
// string (the calendar/date-picker's selected date, a stored expense date)
// is displayed directly rather than built from a Date via the functions
// above. Parses the date portion as local time, not UTC, so the weekday
// matches the calendar day actually shown.
