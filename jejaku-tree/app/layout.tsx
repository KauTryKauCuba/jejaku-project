...
// "in sync" with by fetching it fresh each build. Same files as
// jejaku-receipt's copy — the font itself doesn't change per app.
...
export const metadata: Metadata = {
  title: "Jejaku Tree",
  description: "A family tree you actually add people to.",
};
